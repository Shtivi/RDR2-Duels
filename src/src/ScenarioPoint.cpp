...
int ScenarioPoint::create()
{
	if (entity)
	{
		id = TASK::CREATE_SCENARIO_POINT_HASH_ATTACHED_TO_ENTITY(entity, getScenarioHashKey(), offset.x, offset.y, offset.z, heading, 0, -1, 1); // TASK_CREATE_SCENARIO_POINT_ATTACHED_TO_ENTITY
	}
	else
	{
